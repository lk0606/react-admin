                                ...
                                sshPublisherDesc(
                                    ...
                                    transfers: [
                                        sshTransfer(
                                            ...
                                            // 原始方法提取
                                            execCommand: "cd $source_dir/${project_name}_$BRANCH_NAME && sh ensureDir.sh $source_dir/${project_name}_$BRANCH_NAME $build_dir $project_name $BRANCH_NAME $target_dir",
                                            // docker
